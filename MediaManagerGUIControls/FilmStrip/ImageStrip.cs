...
namespace FilmStrip
{
	...
	/// </summary>
	public class ImageStrip : System.Windows.Forms.UserControl
	{
        ...
        public bool AddPicture(Image image, int picID)
        {
            ...
            decimal heightRatio = ((decimal)image.Width/ (decimal)image.Height );
            width = (int)System.Math.Round((decimal)height * (decimal)heightRatio, 0);//Convert.ToInt32(height*0.70);
            pb.Size = new Size(width, height);
            pb.Location = new Point(pictureBoxOffset, 5);
            lb.Text = picID.ToString();
